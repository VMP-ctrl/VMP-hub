-- ══════════════════════════════════════════════════════════════════════════════
-- VMP HUB — Universal ScriptLoader (free)
...
-- ══════════════════════════════════════════════════════════════════════════════
local CFG = {
    LIB_URL      = "https://premium-keys.oxide-premium.workers.dev/asset?name=lib.enc",
    -- Base URL for stripped game scripts (codeberg raw).
    SCRIPTS_BASE = "https://premium-keys.oxide-premium.workers.dev/asset?name=scripts/",
    -- Fallback script when PlaceId doesn't match any known game
    FALLBACK  = "Universal.lua",
    -- Stats endpoint — reports successful loads + heartbeats for the live page
    TRACK_URL = "https://premium-keys.oxide-premium.workers.dev/track",
}
...
local function Track(kind)
    -- Resolve placeId/scriptName here instead of referencing MAIN's locals:
    -- Track is defined BEFORE those locals are declared, so upvalue capture
    -- would grab the nil globals, not the locals. Computing them here keeps
    -- Track self-contained and correct at call time.
